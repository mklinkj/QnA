 ...
 */
package org.mklinkj.lib.pagination.domain;
...
public interface Pageable {
  ...
  /**
   * Creates a new {@link Pageable} for the first page (page number {@code 0}) given {@code
   * pageSize} .
   *
   ...
   *
   * @return the page to be returned or throws {@link UnsupportedOperationException} if the object
   *     is {@link #isUnpaged()}.
   ...
   *
   * @return the number of items of that page or throws {@link UnsupportedOperationException} if the
   *     object is {@link #isUnpaged()}.
   * @throws UnsupportedOperationException if the object is {@link #isUnpaged()}.
   */
  int getPageSize();
   ...
   *
   * @param pageNumber
   * @return a new {@link PageRequest} or throws {@link UnsupportedOperationException} if the object
   *     is {@link #isUnpaged()} and the {@code pageNumber} is not zero.
   * @since 2.5
   * @throws UnsupportedOperationException if the object is {@link #isUnpaged()}.
   */
  ...
  /**
   * Returns an {@link OffsetScrollPosition} from this pageable if the page request {@link
   * #isPaged() is paged}.
   *
   * @return
  ...
  default OffsetScrollPosition toScrollPosition() {
    ...
    if (isUnpaged()) {
      throw new IllegalStateException(
          "Cannot create OffsetScrollPosition from an unpaged instance");
    }
